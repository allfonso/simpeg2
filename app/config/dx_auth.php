...
$config['DX_users_table'] = 'sys_users';
$config['DX_user_profile_table'] = 'sys_user_profile';
$config['DX_user_temp_table'] = 'sys_user_temp';
$config['DX_user_autologin'] = 'sys_user_autologin';
$config['DX_roles_table'] = 'sys_roles';
$config['DX_permissions_table'] = 'sys_permissions';
$config['DX_login_attempts_table'] = 'sys_login_attempts';
...
$config['DX_salt'] = '1357924680abcdefghijklmnopqrstuvwxyz';
