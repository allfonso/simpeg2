		...
		<div class="easyui-tabs" style="width:100%">
			...
			<div title="Data pendukung" style="padding:10px">
				<table cellpadding="0" cellspacing="2" border="0">
	                ...
	                <tr>
	                    <td>TMT SK CPNS : </td>
	                    <td><input name="inputTMTSKCpns" id="inputTMTSKCpns" class="easyui-datebox" data-options="formatter:date_format" size="30" required></td>
	                </tr>
	                <tr>
	                    <td>TMT SP CPNS : </td>
	                    <td><input name="inputTMTSPCpns" id="inputTMTSPCpns" class="easyui-datebox" data-options="formatter:date_format" size="30" required></td>
	                </tr>
	                <tr>
