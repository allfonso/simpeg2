<div id="dialogDetailPegawai" class="easyui-window" style="width:1300px;height:550px" closed="true" data-options="iconCls:'icon-user'" buttons="#dialogDetailPegawai-buttons">
	<div class="easyui-tabs" style="width:100%;height:auto;">
		<div title="Data pegawai" style="height:200px;" iconCls="icon-user">
			<?php $this->load->view('pegawai/layout_detail_pegawai'); ?>
		</div>
		<div title="Riwayat Golongan" iconCls="icon-user" size="large">
		...
		<div title="Riwayat Jabatan" style="padding-top:1px">
		...
		<div title="Riwayat Diklat" style="padding-top:1px">
		...
		<div title="Riwayat Pendidikan" style="padding-top:1px">
