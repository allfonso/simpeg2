		...
		<div class="easyui-tabs" style="width:100%">
			<div title="Data utama" style="padding:10px">
				<table cellpadding="0" cellspacing="2" border="0">
	                <tr>
	                    <td width="40%">NIP : </td>
	                    <td width="60%"><input name="inputNip" id="inputNip" class="easyui-textbox" size="25" required></td>
	                </tr>
	                <tr>
	                    <td>NIP Lama : </td>
	                    <td><input name="inputNipLama" id="inputNipLama" class="easyui-textbox" size="25"></td>
	                </tr>
	                <tr>
	                    <td>Nama : </td>
	                    <td><input name="inputNama" id="inputNama" class="easyui-textbox" size="30" required></td>
	                </tr>
	                <tr>
	                    <td>Gelar depan : </td>
	                    <td><input name="inputGelarDepan" id="inputGelarDepan" class="easyui-textbox" size="10"></td>
	                </tr>
	                <tr>
	                    <td>Gelar belakang : </td>
	                    <td><input name="inputGelarBelakang" id="inputGelarBelakang" class="easyui-textbox" size="10"></td>
	                </tr>
	                <tr>
	                    <td>Gelar lain : </td>
	                    <td><input name="inputGelarLain" id="inputGelarLain" class="easyui-textbox" size="10"></td>
	                </tr>
	                <tr>
	                    <td>Tempat, Tanggal lahir : </td>
	                    <td>
	                        <input name="inputTempatLahir" id="inputTempatLahir" class="easyui-textbox" size="20" required>&nbsp;
	                        <input name="inputTanggaLahir" id="inputTanggaLahir" class="easyui-datebox" size="15" required>
	                    </td>
	                </tr>
	                <tr>
	                    <td>No Akta Lahir : </td>
	                    <td><input name="inputNoAktaLahir" id="inputNoAktaLahir" class="easyui-textbox" size="30"></td>
	                </tr>
	                <tr>
	                    <td>Jenis Kelamin : </td>
	                    <td>
	                ...
	                <tr>
	                    <td>Alamat : </td>
	                    <td>
	                        <input name="inputAlamat" id="inputAlamat" class="easyui-textbox" size="40" required>
	                    </td>
	                </tr>
	                <tr>
	                    <td>Kodepos : </td>
	                    <td>
	                        <input name="inputKodepos" id="inputKodepos" class="easyui-textbox" size="15" required>
	                    </td>
	                </tr>
	                <tr>
	                    <td>No Handphone</td>
	                ...
	                <tr>
	                    <td>No Identitas : </td>
	                    <td><input name="inputNoIdentitas" id="inputNoIdentitas" class="easyui-textbox" size="30" required></td>
	                </tr>
	                <tr>
	                ...
	                <tr>
	                    <td>Warna kulit : </td>
	                    <td><input name="inputWarnaKulit" id="inputWarnaKulit" class="easyui-textbox" size="30"></td>
	                </tr>	                
	            </table>
			</div>
			<div title="Data pendukung" style="padding:10px">
				<table cellpadding="0" cellspacing="2" border="0">
					...
					<tr>
	                    ...
	                    <td width="60%">
	                    	<input name="inputNoSKCPns" id="inputNoSKCPns" class="easyui-textbox" size="30" required>&nbsp;
	                    	<input name="inputTanggalSKCpns" id="inputTanggalSKCpns" class="easyui-datebox" required>
	                    </td>
	                </tr>	                                   
	                <tr>
	                    <td>TMT SK CPNS : </td>
	                    <td><input name="inputTMTSKCpns" id="inputTMTSKCpns" class="easyui-textbox" size="30" required></td>
	                </tr>
	                <tr>
	                    <td>TMT SP CPNS : </td>
	                    <td><input name="inputTMTSPCpns" id="inputTMTSPCpns" class="easyui-textbox" size="30" required></td>
	                </tr>
	                <tr>
	                    <td>No NPWP / Tanggal NPWP: </td>
	                    <td>
	                    	<input name="inputNoNpwp" id="inputNoNpwp" class="easyui-textbox" size="30">&nbsp;
	                    	<input name="inputTanggalNpwp" id="inputTanggalNpwp" class="easyui-datebox">
	                    </td>
	                </tr>
	                
	                <tr>
	                    <td>No BPJS : </td>
	                    <td><input name="inputNoBpjs" id="inputNoBpjs" class="easyui-textbox" size="30"></td>
	                </tr>
